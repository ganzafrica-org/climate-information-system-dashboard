...
export function AppLayout({ children }: AppLayoutProps) {
    ...
    return (
        <div className="flex h-screen overflow-hidden bg-background">
            <div
                className={`fixed inset-y-0 left-0 z-50 w-64 bg-sidebar text-sidebar-foreground border-r border-border transition-transform duration-300 ease-in-out ${
                    sidebarOpen ? 'translate-x-0' : '-translate-x-full'
                } md:relative md:translate-x-0 ${!sidebarOpen && !isMobile ? 'md:w-20' : ''}`}
            >
                    ...
                    <div className="flex items-center space-x-2">
                        ...
                        >
                            {theme === 'dark' ? (
                                ...
                                <>
                                    <Moon className="h-4 w-4 md:mr-1" />
