...
const arrow = (can: boolean) =>
  `flex h-8 w-8 shrink-0 items-center justify-center rounded-[9px] outline-none transition-colors duration-150 focus-visible:ring-2 focus-visible:ring-ring ${
    can
      ...
      <div className="flex items-center" style={{ gap: GAP }}>
        ...
        <div className="relative">
          <motion.span
            ...
            style={{ width: slot }}
            className="absolute inset-y-0 left-0 rounded-[9px] bg-primary"
          />
              ...
              return (
                <li key={`slot-${item}`} style={{ width: slot }}>
                  <button
                    ...
                    aria-current={selected ? "page" : undefined}
                    onClick={() => pagination.goTo(item)}
                    className={`flex h-8 w-full items-center justify-center rounded-[9px] text-[12.5px] tabular-nums outline-none transition-colors duration-150 focus-visible:ring-2 focus-visible:ring-ring ${
                      selected
