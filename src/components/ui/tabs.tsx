...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-12 gap-1 items-center justify-left rounded-lg bg-muted p-1 text-muted-foreground min-w-full",
      className
    )}
    {...props}
  />
