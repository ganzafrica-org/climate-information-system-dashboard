...
export function Tabs({
  ...
  return (
    <div
      className={`w-full overflow-hidden rounded-[12px] border border-border bg-card shadow-sm ${className}`}
    >
      <div
        {...tabs.tabListProps}
        ref={rowRef}
        ...
        {items.map((item, index) => {
          ...
          return (
            <button
              ...
              className={`relative flex h-8 shrink-0 items-center justify-center rounded-t-[8px] px-3.5 text-[12.5px] outline-none transition-colors duration-150 after:pointer-events-none after:absolute after:inset-0 after:rounded-t-[8px] after:content-[''] focus-visible:after:shadow-[inset_0_0_0_2px_hsl(var(--ring))] ${
                item.disabled
      ...
      {renderPanel ? (
        <motion.div
          ...
          className={`rounded-[11px] text-[13.5px] leading-relaxed text-foreground outline-none focus-visible:shadow-[inset_0_0_0_2px_hsl(var(--ring))] ${panelClassName}`}
        >
