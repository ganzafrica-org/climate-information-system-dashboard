      ...
      {open ? (
        ...
        >
          ...
          <motion.div
            ...
            className={`relative flex w-full flex-col overflow-hidden rounded-[14px] border border-border bg-card text-card-foreground shadow-xl outline-none ${className}`}
          >
            <div className="flex shrink-0 items-start gap-3 px-4 pb-3 pt-4">
              ...
              {showClose ? (
                <button
                  ...
                  className="-mr-1 -mt-1 grid size-7 shrink-0 place-items-center rounded-[7px] text-muted-foreground outline-none transition-colors duration-150 hover:bg-muted hover:text-foreground focus-visible:ring-2 focus-visible:ring-ring"
                >
                  {CLOSE_ICON}
                </button>
              ) : null}
