        ...
        {open ? (
          ...
          >
            <motion.div
              ...
              className={`relative rounded-[11px] border border-border bg-card p-3 shadow-lg focus-visible:outline-none ${className}`}
            >
              <span
                ref={arrowRef}
                aria-hidden
