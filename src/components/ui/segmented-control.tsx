...
// interior.dev SegmentedControl, adapted to the app theme tokens (teal primary
// thumb, muted neutrals). A sliding spring indicator with full keyboard support.
...
export function SegmentedControl({
  ...
  return (
    <div
      role="radiogroup"
      aria-label={label}
      className={`relative inline-block select-none rounded-[9px] border border-border bg-muted/70 p-[3px] ${className}`}
    >
      <div
        ...
        >
          {options.map((option, i) => (
            <button
              ...
              className="cursor-default rounded-[6px] outline-none focus-visible:shadow-[inset_0_0_0_2px_hsl(var(--ring))]"
            >
